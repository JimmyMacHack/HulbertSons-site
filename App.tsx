      ...
      <div className="bg-slate-900 text-gray-300 py-2.5 px-4 text-sm hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex space-x-6">
            <a href="mailto:Jameshulbert59@gmail.com" className="flex items-center hover:text-brandGold transition-colors font-bold uppercase tracking-wider group">
              <Mail className="w-4 h-4 mr-2 text-brandGold group-hover:scale-110 transition-transform" />
              Email
            </a>
            <div className="flex items-center space-x-4">
              <a href="tel:5044527895" className="flex items-center hover:text-brandGold transition-colors font-bold uppercase tracking-wider group border-r border-slate-700 pr-4">
                <Phone className="w-3.5 h-3.5 mr-2 text-brandGold group-hover:scale-110 transition-transform" />
                NOLA: (504) 452-7895
              </a>
              <a href="tel:2815777533" className="flex items-center hover:text-brandGold transition-colors font-bold uppercase tracking-wider group">
                <Phone className="w-3.5 h-3.5 mr-2 text-brandGold group-hover:scale-110 transition-transform" />
                TX: (281) 577-7533
              </a>
            </div>
          ...
          <div className="text-xs text-slate-500 font-bold tracking-widest uppercase flex items-center gap-4">
            ...
            <span className="text-[#EAB207] border-l border-slate-700 pl-4 animate-pulse uppercase italic">Houston branch now open!</span>
          </div>
        </div>
      </div>
                ...
                {isPhoneDropdownOpen && (
                  <div className="absolute right-0 mt-3 w-72 bg-white rounded-2xl shadow-2xl border border-brandGold/20 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                    <div className="p-4 bg-slate-900 text-white">
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-brandGold opacity-80 mb-1">Select a branch</p>
                      <h4 className="text-sm font-bold italic">Where can we help you today?</h4>
                    </div>
                    <div className="p-2">
                      <a 
                        href="tel:5044527895"
                      ...
                      >
                        ...
                        <div>
                          <p className="text-xs font-black uppercase tracking-widest text-slate-500">New Orleans, LA</p>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-xs font-black uppercase tracking-widest text-slate-500">Houston, TX</p>
          ...
          <div className="md:hidden bg-white border-t border-gray-100 absolute w-full shadow-2xl animate-in slide-in-from-top-5 z-40">
            <div className="px-4 pt-2 pb-8 space-y-1">
              ...
              <div className="px-4 py-4 mt-4 border-t border-slate-100">
                <p className="text-xs font-black uppercase tracking-widest text-brandGold italic animate-pulse">
                  <MapPin className="inline-block w-3 h-3 mr-1" /> Now serving Greater Houston & NOLA!
                </p>
              </div>
            </div>
          </div>
