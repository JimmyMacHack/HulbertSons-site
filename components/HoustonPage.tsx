...
import { ArrowLeft, MapPin, Star, Shield, Zap, ChevronDown, Phone, Wind, Home, Droplets, ShieldAlert } from 'lucide-react';
...
const HoustonPage: React.FC<HoustonPageProps> = ({ navigateTo }) => {
  ...
  return (
    <div className="bg-white min-h-screen">
              ...
              <RevealOnScroll>
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                  {['Sugar Land', 'The Woodlands', 'Katy', 'Pearland', 'Cypress', 'Kingwood', 'Memorial', 'Heights'].map((area, i) => (
                    <div key={i} className="flex items-center text-slate-800 font-bold group cursor-default">
            ...
            <div className="lg:w-1/2">
              <RevealOnScroll delay={200} className="relative rounded-3xl overflow-hidden shadow-2xl aspect-video md:aspect-square">
                 <img 
                   ...
                   alt="Houston Luxury Home Detail" 
      ...
      {/* Houston Specialty Services - Handyman Focused */}
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <RevealOnScroll className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-block px-4 py-1.5 mb-4 text-xs font-black tracking-widest text-slate-900 uppercase bg-white rounded-full border border-slate-200">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <RevealOnScroll key={i} delay={i * 100} className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex flex-col h-full group hover:border-brandGold transition-all">
                <div className="bg-slate-900 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-brandGold transition-colors">
                ...
                <div className="mb-4">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight uppercase italic">{service.title}</h3>
                </div>
                <p className="text-slate-600 font-medium leading-relaxed mb-6 flex-grow">{service.desc}</p>
                <div className="pt-6 border-t border-slate-50">
                  <button 
                    ...
                    className="text-xs font-black uppercase tracking-widest text-slate-900 flex items-center group/btn"
                  >
