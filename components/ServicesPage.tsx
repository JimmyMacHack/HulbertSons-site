...
import { ArrowLeft, PaintBucket, Hammer, Repeat } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 via-yellow-50/10 to-white min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        {/* Featured Transformation Collage */}
        <RevealOnScroll className="mb-24">
          <div className="bg-white rounded-[3rem] p-12 shadow-2xl border border-slate-100">
            <div className="grid lg:grid-cols-2 items-center gap-16">
              <div>
                <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic mb-6">Featured <span className="text-brandGold">Transformation</span></h2>
                <p className="text-lg text-slate-600 font-medium mb-8 leading-relaxed">
                  Our workmanship speaks for itself. Click the interactive display to see how we bring old properties back to their prime state. This is the quality you can expect on every Hulbert & Sons project.
                </p>
                <div className="flex gap-4">
                  <div className="flex items-center gap-2 px-4 py-2 bg-slate-100 rounded-full">
                    <div className="w-2 h-2 bg-slate-400 rounded-full"></div>
                    <span className="text-[10px] font-black uppercase text-slate-500">Before Restoration</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 bg-brandGold/10 rounded-full border border-brandGold/20">
                    <div className="w-2 h-2 bg-brandGold rounded-full"></div>
                    <span className="text-[10px] font-black uppercase text-brandGold">After Hulbert & Sons</span>
                  </div>
                </div>
              </div>
              ...
              <div 
                className="relative h-[450px] cursor-pointer group/collage select-none"
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  >
                    ...
                    />
                    <div className="absolute top-4 left-4 bg-black/80 backdrop-blur-md text-white px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest">Before</div>
                  </div>
                  ...
                  >
                    <img 
                      ...
                      className="w-full h-full object-cover"
                    />
                    <div className="absolute top-4 left-4 bg-brandGold text-slate-900 px-5 py-2 rounded-lg text-xs font-black uppercase tracking-widest">After</div>
                  </div>

                  {/* UI Hint */}
                  <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-slate-900 text-brandGold px-6 py-2 rounded-full flex items-center gap-2 z-30 shadow-xl group-hover/collage:scale-105 transition-transform">
                    <Repeat className="w-4 h-4 animate-spin-slow" />
                    <span className="text-[10px] font-black uppercase tracking-widest">Tap to Swap</span>
                  </div>
                </div>
              </div>
            </div>
