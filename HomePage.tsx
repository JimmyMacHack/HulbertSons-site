...
import { CheckCircle, Star, Clock, HardHat, ChevronLeft, ChevronRight, ArrowRight, Video, Phone, Mail, PaintBucket, Hammer, MapPin } from 'lucide-react';
          ...
          <div className="md:w-3/4 lg:w-2/3">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              ...
              <div className="inline-flex items-center space-x-2 bg-brandGold/20 border border-brandGold/30 rounded-full px-4 py-1.5 backdrop-blur-sm">
                ...
                <span className="text-brandGold text-xs md:text-sm font-black tracking-widest uppercase animate-pulse italic">Houston Branch Coming Soon</span>
              </div>
            </div>
      ...
      <section id="services-summary" className="py-24 bg-gradient-to-br from-white via-yellow-50/20 to-slate-100 relative border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            {/* Exterior Card - TRUMPET GOLD (#EAB207) */}
            ...
            <RevealOnScroll>
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center text-white group cursor-pointer hover:translate-x-2 transition-transform">
                    ...
                    <div>
                      <p className="text-xs text-brandGold font-black uppercase tracking-widest mb-1">Call Us Now</p>
                      <p className="text-3xl font-black tracking-tight">(504) 452-7895</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-12 p-8 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl border border-brandGold/20 backdrop-blur-sm shadow-2xl">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-white mb-3 uppercase tracking-tighter italic">Free Virtual Estimate</h3>
